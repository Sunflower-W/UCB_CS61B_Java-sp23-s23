...
//         assertThat(lld1.toList()).containsExactly("back").inOrder();
    ...
    @Test
    /** In this test, we have some different assert statement that verify that isEmpty and size work correctly. */
    public void isEmptyAndSizeTest() {
        Deque<String> lld1 = new LinkedListDeque<>();
        assertThat(lld1.isEmpty()).isTrue();
        assertThat(lld1.size()).isEqualTo(0);
        lld1.addFirst("flyPig");
    ...
    public void getTest() {
        // Test the cases where get receives an invalid argument
        Deque<Integer> lld1 = new LinkedListDeque<>();
//        lld1.addLast(333); // 都可以
        lld1.addFirst(333);
        assertWithMessage("get receives an invalid index").that(lld1.get(28723)).isEqualTo(null);
        assertWithMessage("get receives an invalid index").that(lld1.get(-1)).isEqualTo(null);
        assertThat(lld1.get(0)).isEqualTo(333);
    }
